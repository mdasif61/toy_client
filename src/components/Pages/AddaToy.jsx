    ...
    <div className="min-h-[calc(100vh-146px)] flex items-center justify-center">
      <div className="w-full">
        ...
        <form className="w-full">
          <div className="w-full bg-orange-50 border-2 border-orange-600 p-10 rounded-xl grid md:grid-cols-2 grid-cols-1 gap-5">
            <div className="w-full">
              <label htmlFor="name">
            ...
            <div className="w-full">
              ...
              <br />
              <textarea
                className="w-full mt-2 resize-none border focus:border-b-2 focus:border-orange-500 focus:outline-none py-2 px-4 h-12"
                name="desc"
                id=""
          ...
          <button className="btn btn-block bg-orange-500 border-none">
            Add Toy
          </button>
        </form>
      </div>
