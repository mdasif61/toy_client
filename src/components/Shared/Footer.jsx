            ...
            <div className='md:flex justify-between'>
                <div className='flex justify-center items-center mb-5 md:mb-0 flex-col'>
                    ...
                    <h1 className="text-white font-semibold md:text-xl text-lg">
                        Sports<span className="text-orange-500 font-bold md:text-4xl text-2xl">&</span>
                        Special
                    </h1>
                </div>
                <div>
                    <div className='mt-5 md:mt-0'>
                        <h1 className='md:text-xl text-base font-bold text-white border-b-2 uppercase'>Categorys</h1>
                ...
                <div>
                    <div className='mt-5 md:mt-0'>
                        <h1 className='md:text-xl text-base font-bold text-white border-b-2 uppercase'>Support</h1>
                        <ul className='text-sm text-white'>
                ...
                <div className='md:w-[30%] w-full mt-5 md:mt-0'>
                    <h1 className='md:text-xl text-base font-bold text-white border-b-2 uppercase'>Contact Us</h1>
                    <div className='flex md:flex-row flex-col mt-5'>
                       <input type="text" className='h-10 w-full md:w-auto rounded-full py-2 px-4 focus:outline-none border-none' name="" placeholder='Email Here' id="" />
                       <button className='h-10 mt-3 md:mt-0 bg-red-600 py-2 px-4 rounded-full md:ml-2 hover:bg-transparent hover:border-red-600 hover:border-2 text-white'>Subscribe</button>
                    </div>
                    <div className='md:mt-10 mt-5'>
                        <h1 className='uppercase mb-3 border-b-2 font-bold md:text-xl text-base text-white'>Social Media</h1>
